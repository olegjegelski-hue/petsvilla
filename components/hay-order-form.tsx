...
export function HayOrderForm() {
  ...
  // Check if Montonio is enabled (client-side only, set at build time)
  const montonioEnabled = typeof window !== 'undefined' 
    ? process.env.NEXT_PUBLIC_MONTONIO_ENABLED === 'true'
    : false
