...
import { Package, MapPin, Clock, Euro, Truck } from 'lucide-react'
      ...
      <p className="text-gray-700 text-lg mb-8">
                  ...
                  <section className="mb-8">
                    <div className="flex items-center mb-4">
                      <Package className="w-8 h-8 text-[#1F6A4C] mr-3" />
                      <h2 className="text-2xl font-bold text-green-900 m-0">1. SmartPost Pakiautomaat</h2>
                    </div>
              
                    <div className="bg-[#E8DFD3]/90 border border-[#D7CBBE] rounded-lg p-6 mb-6">
                      <h3 className="text-lg font-semibold text-green-900 mb-3">Miks SmartPost?</h3>
                    ...
                    <h3 className="text-xl font-semibold text-green-900 mb-3">Kuidas toimib?</h3>
                    ...
                    {/* Info box */}
                    <div className="bg-[#E8DFD3]/80 border-l-4 border-[#1F6A4C] p-4 mb-6 rounded-r-lg">
                      <p className="text-green-900 text-sm">
                        📱 <strong>Jälgimiskood:</strong> Pärast paki saatmist saad e-kirja, kus on SmartPost jälgimisnumber. 
                        Saad jälgida saadetist aadressil <a href="https://www.smartpost.ee" target="_blank" rel="noopener noreferrer" className="text-[#1F6A4C] hover:underline">smartpost.ee</a>
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="mb-8">
                    <div className="flex items-center mb-4">
                      ...
                      <h2 className="text-2xl font-bold text-green-900 m-0">2. Tarneajad</h2>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      ...
                      <div className="bg-[#E8DFD3]/90 border border-[#D7CBBE] rounded-lg p-6">
                        <h3 className="text-lg font-semibold text-green-900 mb-3">🐹 Merisead ja viirpapagoid</h3>
                        <ul className="text-green-800 space-y-2 text-sm">
                    ...
                    <div className="bg-[#E8DFD3]/80 border border-[#C8A93E]/50 rounded-lg p-4">
                      <p className="text-green-900 text-sm">
                  ...
                  <section className="mb-8">
                    <div className="flex items-center mb-4">
                      <Euro className="w-8 h-8 text-[#1F6A4C] mr-3" />
                      <h2 className="text-2xl font-bold text-green-900 m-0">3. Tarnekulud</h2>
                    </div>
                    ...
                    <div className="overflow-x-auto mb-6">
                      <table className="min-w-full bg-white border border-gray-300 rounded-lg">
                        <thead className="bg-[#E3D8CB]">
                          <tr>
                            <th className="px-6 py-3 text-left text-sm font-semibold text-green-900 border-b">Paki kaal</th>
                            <th className="px-6 py-3 text-left text-sm font-semibold text-green-900 border-b">Tarnekulu</th>
                            <th className="px-6 py-3 text-left text-sm font-semibold text-green-900 border-b">Näide</th>
                          </tr>
                        </thead>
                    ...
                    <div className="bg-[#E8DFD3]/90 border border-[#D7CBBE] rounded-lg p-4">
                  ...
                  <section className="mb-8">
                    <div className="flex items-center mb-4">
                      ...
                      <h2 className="text-2xl font-bold text-green-900 m-0">4. Pakiautomaatide asukohad</h2>
                    </div>
                    ...
                    <div className="bg-gray-50 border border-gray-300 rounded-lg p-6 mb-6">
                      <h3 className="text-lg font-semibold text-green-900 mb-3">🗺️ Leia oma lähim pakiautomaat:</h3>
                      <a 
                        href="https://www.smartpost.ee/et" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="inline-flex items-center bg-[#1F6A4C] hover:bg-[#19563d] text-white font-semibold px-6 py-3 rounded-lg transition-colors"
                      >
                  ...
                  <section className="mb-8">
                    <div className="flex items-center mb-4">
                      <Truck className="w-8 h-8 text-[#1F6A4C] mr-3" />
                      <h2 className="text-2xl font-bold text-green-900 m-0">5. Eluslooma üleandmine</h2>
                    </div>

                    <div className="bg-[#E8DFD3]/90 border-l-4 border-[#C8A93E] p-6 mb-6 rounded-r-lg">
                      <h3 className="text-lg font-semibold text-green-900 mb-3">🐹 Merisead ja viirpapagoid</h3>
                    ...
                    <h3 className="text-xl font-semibold text-green-900 mb-3">Kuidas toimub üleandmine?</h3>
                    <ol className="list-decimal list-inside text-gray-700 space-y-3 mb-6">
                      <li>
                        <strong>Kontakteeru meiega:</strong>
                        <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                          <li>E-post: <a href="mailto:service@petsvilla.ee" className="text-[#1F6A4C] hover:underline">service@petsvilla.ee</a></li>
                          <li>Või läbi <Link href="/meriseabeebid" className="text-[#1F6A4C] hover:underline">merisigade galerii</Link> kontaktivormi</li>
                        </ul>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                          <li><strong>Meie asukoht:</strong> Tartu mnt 80, Soinaste, Kambja vald, Tartumaa 61709</li>
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">6. Jälgimine ja teavitused</h2>
                    <p className="text-gray-700 mb-4">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start space-x-4">
                        <div className="bg-[#E3D8CB] rounded-full p-3 flex-shrink-0">
                          <span className="text-[#1F6A4C] font-bold">1</span>
                        </div>
                        <div>
                          <h3 className="font-semibold text-green-900">Tellimuse kinnitus</h3>
                      ...
                      <div className="flex items-start space-x-4">
                        <div className="bg-[#E3D8CB] rounded-full p-3 flex-shrink-0">
                          <span className="text-[#1F6A4C] font-bold">2</span>
                        </div>
                        <div>
                          <h3 className="font-semibold text-green-900">Paki saatmine</h3>
                      ...
                      <div className="flex items-start space-x-4">
                        <div className="bg-[#E3D8CB] rounded-full p-3 flex-shrink-0">
                          <span className="text-[#1F6A4C] font-bold">3</span>
                        </div>
                        <div>
                          <h3 className="font-semibold text-green-900">Pakk jõudis automaati</h3>
                      ...
                      <div className="flex items-start space-x-4">
                        <div className="bg-[#E3D8CB] rounded-full p-3 flex-shrink-0">
                          <span className="text-[#1F6A4C] font-bold">4</span>
                        </div>
                        <div>
                          <h3 className="font-semibold text-green-900">Meeldetuletus</h3>
                  ...
                  {/* 7. KKK */}
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">7. Korduma kippuvad küsimused</h2>
              
                    <div className="space-y-4">
                      <details className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        <summary className="font-semibold text-green-900 cursor-pointer">Kui kaua hoitakse pakki automaadis?</summary>
                      ...
                      <details className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        <summary className="font-semibold text-green-900 cursor-pointer">Kas saan muuta tarne aadressi?</summary>
                        <p className="text-gray-700 text-sm mt-2">
                      ...
                      <details className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        <summary className="font-semibold text-green-900 cursor-pointer">Mis saab, kui pakk kaob või on kahjustatud?</summary>
                        <p className="text-gray-700 text-sm mt-2">
                      ...
                      <details className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        <summary className="font-semibold text-green-900 cursor-pointer">Kas saate toimetada koju?</summary>
                        <p className="text-gray-700 text-sm mt-2">
                  ...
                  {/* KONTAKT */}
                  <section className="bg-[#E8DFD3]/90 rounded-xl p-6 mt-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">Küsimused tarne kohta?</h2>
                    <p className="text-gray-700 mb-4">
                      Kui sul on küsimusi, võta meiega ühendust:
                    </p>
                    <div className="text-gray-700 space-y-2">
                      <p><strong>E-post:</strong> <a href="mailto:service@petsvilla.ee" className="text-[#1F6A4C] hover:underline">service@petsvilla.ee</a></p>
