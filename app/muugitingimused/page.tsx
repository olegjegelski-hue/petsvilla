...
export default function Page() {
  return (
    <LegalPageShell
      ...
      subtitle="Kehtivad alates: 28.11.2025 · Viimati uuendatud: 28.11.2025"
    >
{/* 1. ÜLDISED TINGIMUSED */}
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">1. Üldised tingimused</h2>
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">2. Tooted ja teenused</h2>
                    <p className="text-gray-700 mb-4">
                      PetsVilla müüb:
                    </p>
                  ...
                  {/* 3. HINNAD */}
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">3. Hinnad</h2>
                    <p className="text-gray-700 mb-4">
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">4. Tarneviisid ja -kulud</h2>
                    <p className="text-gray-700 mb-4">
                  ...
                  {/* 5. MAKSEVIISID */}
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">5. Makseviisid</h2>
                    <p className="text-gray-700 mb-4">
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">6. Tellimuse kinnitamine</h2>
                    <p className="text-gray-700 mb-4">
                  ...
                  {/* 7. TAGANEMISÕIGUS */}
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">7. Taganemisõigus (14 päeva)</h2>
                    <p className="text-gray-700 mb-4">
                    ...
                    <p className="text-gray-700">
                      Taganemisavalduse saab saata e-posti aadressile: <a href="mailto:service@petsvilla.ee" className="text-[#1F6A4C] hover:underline">service@petsvilla.ee</a>
                    </p>
                  </section>

                  {/* 8. TAGASTAMINE JA RAHA TAGASTAMINE */}
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">8. Tagastamine ja raha tagastamine</h2>
                    <p className="text-gray-700 mb-4">
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">9. Garantii ja pretensioonid</h2>
                    <p className="text-gray-700 mb-4">
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">10. Vastutuse piiramine</h2>
                    <p className="text-gray-700 mb-4">
                      Müüja ei vastuta:
                    </p>
                    <ul className="list-disc list-inside text-gray-700 space-y-2">
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">11. Isikuandmete töötlemine</h2>
                    <p className="text-gray-700 mb-4">
                      Tellimuse esitamisel töödeldakse ostja isikuandmeid vastavalt 
                      <Link href="/privaatsuspoliitika" className="text-[#1F6A4C] hover:underline"> privaatsuspoliitikale</Link>.
                    </p>
                    <p className="text-gray-700">
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">12. Vaidluste lahendamine</h2>
                    <p className="text-gray-700 mb-4">
                      Vaidluste korral palume esmajoones pöörduda müüja poole: 
                      <a href="mailto:service@petsvilla.ee" className="text-[#1F6A4C] hover:underline">service@petsvilla.ee</a>
                    </p>
                    <p className="text-gray-700 mb-4">
                      Kui kokkulepet ei saavutata, on ostjal õigus pöörduda:
                    </p>
                    <ul className="list-disc list-inside text-gray-700 space-y-2">
                      <li><strong>Tarbijavaidluste Komisjon:</strong> <a href="https://komisjon.ee" target="_blank" rel="noopener noreferrer" className="text-[#1F6A4C] hover:underline">komisjon.ee</a></li>
                      <li><strong>Euroopa Liidu ODR platvorm:</strong> <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-[#1F6A4C] hover:underline">ec.europa.eu/consumers/odr</a></li>
                    </ul>
                  </section>

                  {/* KONTAKT */}
                  <section className="bg-[#E8DFD3]/90 rounded-xl p-6 mt-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">Kontaktandmed</h2>
                    ...
                    <p className="text-gray-700 mb-2"><strong>E-post:</strong> <a href="mailto:service@petsvilla.ee" className="text-[#1F6A4C] hover:underline">service@petsvilla.ee</a></p>
                    <p className="text-gray-700"><strong>Veebileht:</strong> <a href="https://petsvilla.ee" className="text-[#1F6A4C] hover:underline">petsvilla.ee</a></p>
                  </section>
    </LegalPageShell>
  )
}
