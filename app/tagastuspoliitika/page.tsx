    ...
    >
      <div className="bg-green-50 border-l-4 border-green-500 p-6 mb-8 rounded-r-lg">
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">1. Taganemisõigus (14 päeva)</h2>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
                      <div className="flex items-start space-x-3">
                        <Clock className="w-6 h-6 text-[#1F6A4C] flex-shrink-0 mt-1" />
                        <div>
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">2. Tagastatavad tooted</h2>
                    <p className="text-gray-700 mb-4">
                  ...
                  {/* 3. TAGASTAMISE KULUD */}
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">3. Tagastamise kulud</h2>
                    <div className="bg-[#E8DFD3]/90 border border-[#D7CBBE] rounded-lg p-6 mb-6">
                      <div className="flex items-start space-x-3">
                        <Euro className="w-6 h-6 text-[#1F6A4C] flex-shrink-0 mt-1" />
                        <div>
                          <h3 className="text-lg font-semibold text-green-900 mb-3">Kes maksab tagastamise eest?</h3>
                  ...
                  {/* 4. RAHA TAGASTAMINE */}
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">4. Raha tagastamine</h2>
                    <p className="text-gray-700 mb-4">
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">5. Defektse kauba tagastamine</h2>
                    <p className="text-gray-700 mb-4">
                      Kui toode on kahjustatud, vigane või ei vasta kirjeldusele:
                    </p>
                    <ol className="list-decimal list-inside text-gray-700 space-y-3 mb-6">
                      <li>
                        <strong>Teavita meid 7 päeva jooksul:</strong> <a href="mailto:service@petsvilla.ee" className="text-[#1F6A4C] hover:underline">service@petsvilla.ee</a>
                      </li>
                      <li>
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">6. Eluslooma terviseprobleemid</h2>
                    <p className="text-gray-700 mb-4">
                  ...
                  <section className="bg-[#E8DFD3]/90 rounded-xl p-6 mt-8">
                    <h2 className="text-2xl font-bold text-green-900 mb-4">Küsimused tagastamise kohta?</h2>
                    <p className="text-gray-700 mb-4">
